   ...
   public void CreateExam(){
     ...
     try {
        ...
        eSet = new ExamQuestion[questionNum];
            ...
            eSet[i].setrAnswer1(rs.getString("Answer1"));
            eSet[i].setrAnswer2(rs.getString("Answer2"));
            eSet[i].setrAnswer3(rs.getString("Answer3"));
            eSet[i].setHint(rs.getString("Hint"));
            eSet[i].setQuestion(rs.getString("Question"));
            double p = Double.parseDouble(rs.getString("Points"));
            eSet[i].setQuestionPoints(p);
     }
